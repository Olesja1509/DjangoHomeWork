...
<head>
    ...
    <meta name="description" content="">    <meta name="generator" content="Hugo 0.84.0">
    <title>Catalog</title>
    <!-- Bootstrap core CSS -->
        ...
        <main class="row">
            ...
            <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <strong>Оформление online-заказа: </strong>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <strong>Гарантийные условия</strong>
                        </div>
                    </div>
                </div>
            </div>
            <header>
                <div class="pricing-header p-3 pb-md-1 mx-auto text-center">
                    <p class="fs-5 text-body-secondary">Заказы</p>
                </div>
            </header>
            <table class="table">
                <thead>
